...
Q-learning Maze Game - Explained Version with English Comments
Author: [Your Name]
Date: March 2026
...
GAME OVERVIEW
====================================
This is a maze-solving game where an AI agent learns to find the target (cheese)
using Q-learning reinforcement learning. The agent starts with no knowledge
and learns through trial and error.

Key Concepts:
- State: The current position and surroundings of the agent
- Action: Moving UP, DOWN, LEFT, or RIGHT
- Reward: Points given for good/bad actions
- Q-table: Memory of what actions are good in each state
"""
